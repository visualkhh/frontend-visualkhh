...
JavaScriptUtil.isInstancdOf=function(object_o,instance){
	if(undefined == object_o || null == object_o){
		return false;
	}else{
		return  object_o instanceof instance;
	}
};
...
JavaScriptUtil.isHtmlElement=function(object_o){
	return object_o instanceof HTMLElement;
}
